 ...
 * @param domElement
 */
function ScenesControl(object, domElement) {
    // API
...
ScenesControl.prototype = Object.create(THREE.EventDispatcher.prototype);
ScenesControl.prototype.constructor = ScenesControl;

export { ScenesControl };
